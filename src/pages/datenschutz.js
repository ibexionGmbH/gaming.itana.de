...
function DatenschutzPage() {
  return (
    <Layout>
      ...
      <div>
        <p>
          Wir freuen uns über Ihr Interesse an unserem Unternehmen. Datenschutz
          hat einen besonders hohen Stellenwert für die Geschäftsleitung der
          Itana GmbH.
        </p>
        <p>&nbsp;</p>
        <p>
          Eine Nutzung der Internetseiten der Itana GmbH ist grundsätzlich ohne
        ...
        <p>
          ...
          und in Übereinstimmung mit den für die Itana GmbH geltenden
        ...
        <p>&nbsp;</p>
        <p>
          Die Itana GmbH hat als für die Verarbeitung Verantwortlicher
        ...
        <p>&nbsp;</p>
        <p>
          Die Datenschutzerklärung der Itana GmbH beruht auf den
        ...
        <p>&nbsp;</p>
        <p>
          Die Internetseiten der Itana GmbH verwenden Cookies. Cookies sind
        ...
        <p>&nbsp;</p>
        <p>
          Durch den Einsatz von Cookies kann die Itana GmbH den Nutzern dieser
        ...
        <p>&nbsp;</p>
        <p>
          Die Internetseite der Itana GmbH erfasst mit jedem Aufruf der
        ...
        <p>
          ...
          Itana GmbH keine Rückschlüsse auf die betroffene Person. Diese
        ...
        <p>&nbsp;</p>
        <p>
          Diese anonym erhobenen Daten und Informationen werden durch die Itana
        ...
        <p>&nbsp;</p>
        <p>
          Die Internetseite der Itana GmbH enthält aufgrund von gesetzlichen
        ...
        <ul>
          ...
          <li className="ml-4">
            ...
            internationaleOrganisation übermittelt wurden. Sofern dies der Fall
        ...
        <p>
          ...
          nicht erforderlich ist: Die personenbezogenen Daten wurden für solche
          Zwecke erhoben oder auf sonstige Weise verarbeitet, für welche sie
          nicht mehr notwendig sind. Die betroffene Person widerruft ihre
          Einwilligung, auf die sich die Verarbeitung gemäß Art. 6 Abs. 1
          Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a DS-GVO stützte, und
        ...
        <p>
          ...
          Informationsgesellschaft gemäß Art. 8 Abs. 1 DS-GVO erhoben. Sofern
          einer der oben genannten Gründe zutrifft und eine betroffene Person
          die Löschung von personenbezogenen Daten, die bei der Itana GmbH
          ...
          Der Mitarbeiter der Itana GmbH wird veranlassen, dass dem
          Löschverlangen unverzüglich nachgekommen wird.
        </p>
        <p>&nbsp;</p>
        <p>
          Wurden die personenbezogenen Daten von der Itana GmbH öffentlich
          ...
          so trifft die Itana GmbH unter Berücksichtigung der verfügbaren
          ...
          die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Itana
        ...
        <p>
          ...
          Richtigkeit der personenbezogenen Daten wird von der betroffenen
          Person bestritten, und zwar für eine Dauer, die es dem
          Verantwortlichen ermöglicht, die Richtigkeit der personenbezogenen
          Daten zu überprüfen. Die Verarbeitung ist unrechtmäßig, die betroffene
          ...
          bei derItana GmbH gespeichert sind, verlangen möchte, kann sie sich
          hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
          Verantwortlichen wenden. Der Mitarbeiter der Itana GmbH wird die
        ...
        <p>
          ...
          nicht für die Wahrnehmung einer Aufgabe erforderlich ist, die
          imöffentlichen Interesse liegt oder in Ausübung öffentlicher Gewalt
        ...
        <p>
          ...
          betroffene Person jederzeit an einen Mitarbeiter der Itana GmbH
          wenden.
        </p>
        <p>&nbsp;</p>
        <p>
          ...
          Bestimmungen gestütztes Profiling. Die Itana GmbH verarbeitet die
        ...
        <p>&nbsp;</p>
        <p>
          Verarbeitet die Itana GmbH personenbezogene Daten, um Direktwerbung zu
          ...
          Widerspricht die betroffene Person gegenüber der Itana GmbH der
          Verarbeitung für Zwecke der Direktwerbung, so wird die Itana GmbH die
          ...
          personenbezogener Daten, die bei der Itana GmbH zu wissenschaftlichen
        ...
        <p>
          ...
          Person direkt jeden Mitarbeiter der Itana GmbH oder einen anderen
        ...
        <p>
          ...
          trifft die Itana GmbH angemessene Maßnahmen, um die Rechte und
        ...
        <p>
          ...
          Zweck der Google-AdSense-Komponente ist die Einbindung von
        ...
        <p>
          ...
          Internetseite auszuwerten. Über Google AdSense werden personenbezogene
          Daten und Informationen, was auch die IP-Adresse umfasst und zur
          Erfassung und Abrechnung der angezeigten Werbeanzeigen notwendig ist,
          an die Alphabet Inc. in die Vereinigten Staaten von Amerika
          übertragen. Diese personenbezogenen Daten werden in den Vereinigten
          Staaten von Amerika gespeichert und verarbeitet. Die Alphabet Inc.
        ...
        <p>
          ...
          unsere Internetseitenaus einem Mitgliedstaat der Europäischen Union
        ...
        <p>
          ...
          stehende Dienstleistungen zu erbringen. Google Analytics setzt ein
          Cookie auf dem informationstechnologischen System der betroffenen
          Person. Was Cookies sind, wurde oben bereits erläutert.
        </p>
        <p>&nbsp;</p>
        <p>
          ...
          Google in den Vereinigten Staaten von Amerika gespeichert. Google gibt
        ...
        <p>
          ...
          Inc., 1600 Amphitheatre Pkwy, Mountain View, CA 94043-1351, USA. Der
          Zweck von Google AdWords ist die Bewerbung unserer Internetseite durch
          die Einblendung von interessenrelevanter Werbung auf den
          Internetseiten von Drittunternehmen und in den
          Suchmaschinenergebnissen der Suchmaschine Google und eine Einblendung
          von Fremdwerbung auf unserer Internetseite. Gelangt eine betroffene
          Person über eine Google-Anzeige auf unsere Internetseite, wird auf dem
          informationstechnologischen System der betroffenen Person durch Google
          ein sogenannter Conversion-Cookie abgelegt. Was Cookies sind, wurde
          oben bereits erläutert. Ein Conversion-Cookie verliert nach dreißig
          Tagen seine Gültigkeit und dient nicht zur Identifikation der
          betroffenen Person. Über den Conversion-Cookie wird, sofern das Cookie
          noch nicht abgelaufen ist, nachvollzogen, ob bestimmte Unterseiten,
        ...
        <p>&nbsp;</p>
        <p>
          <strong>11. Rechtsgrundlage der Verarbeitung</strong>
        </p>
        <p>&nbsp;</p>
        <p>
        ...
        <p>
          ...
          gestattet, weil sie durch den Europäischen Gesetzgeber besonders
          erwähnt wurden. Er vertrat insoweit die Auffassung, dass ein
          berechtigtes Interesse anzunehmen sein könnte, wenndie betroffene
        ...
        <p>
          ...
          Mitarbeiter klärt den Betroffenen einzelfallbezogen darüber auf, ob
          die Bereitstellung der personenbezogenen Daten gesetzlich oder
        ...
        <p>
          ...
          Datenschutzbeauftragter Oberbayern tätig ist, in Kooperation mit dem
          Anwalt für Datenschutz Christian Solmecke erstellt.
        </p>
      </div>
    </Layout>
  )
